    ...
    <main className={app__dashboard}>
      ...
      <main className={dashboard__main}>
        ...
        <section className={dashboard__bars}>
          <DashboardBar Icon={MdDone} aboutCases='Total number of cases' caseCount={400} labelA='Accepted Cases' labelB='Rejected Cases' colorA='#14A84E' colorB="#BA1A1A" />
        </section>

        <section className={dashboard__areas}>
          <DashboardArea Icon={BsBagPlus} labelA='Total Case Requests' labelB='Cases Handled Till Date' colorA='#b9017f' colorB='#105cae'/>
        </section>
